...
public class EventsActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> branchArrayAdapter = new ArrayAdapter<>(this, android.R.layout.simple_spinner_dropdown_item, Constants.eventNames);
        ...
        spBranch.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ArrayAdapter<String> eventArrayAdapter = new ArrayAdapter<>(EventsActivity.this, android.R.layout.simple_spinner_dropdown_item, Constants.SubEventsMap.get(spBranch.getSelectedItem()));
        ...
        spEvent.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                    selectedEventHash = eventHash.get(spEvent.getSelectedItem().toString());
